      ...
      <div>
        <form className="boardup" onSubmit={this.handleSubmit}> 
          ...
          <div className="boardupCenter">
            <div id="content" contenteditable="true" >무슨 일이 일어나고 있나요?</div>
            ...
            <div className="boardupBottom">
              ...
              <div className="boardupBottomRight"><button className="InputBoardBtn" type="submit" onClick={this.openBoard}>트윗하기</button>
              </div>
            </div>  
          </div>
        </form>
